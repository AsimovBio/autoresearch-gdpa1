...
def main():
    ...
    for fold in range(N_FOLDS):
        ...
        et_preds = np.zeros((len(val_idx), n_targets), dtype=np.float32)
        ...
        for j in range(n_targets):
            ...
            rf = RandomForestRegressor(n_estimators=600, max_depth=8,
            ...
            et = ExtraTreesRegressor(n_estimators=600, max_depth=10,
